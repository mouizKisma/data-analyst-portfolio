...
# ✅ Your folder setup
ascii_folder = Path("/Users/mouizkisma/Downloads/Predictive project/Bearing Data/BearingsData/IMS/3rd_test/txt")
...
output_csv = output_folder / "combined_bearings_data03.csv"
